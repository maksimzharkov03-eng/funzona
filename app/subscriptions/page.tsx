...
export default function SubscriptionsPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white px-4 sm:px-6 py-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <a
          href="/catalog"
          className="inline-flex w-fit border border-yellow-400/30 bg-white/5 px-5 py-3 rounded-2xl font-black hover:border-yellow-400 hover:bg-yellow-400/10 transition mb-8"
        >
          ← Назад в каталог
        </a>
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          {subscriptionCountries.map((item) => (
            <button
              ...
              className={`px-6 py-4 rounded-2xl transition border font-black ${
                country === item
          ...
          {groupedPlans.map((group) => (
            ...
            >
              <div className="bg-yellow-400 text-black px-5 py-4">
                ...
                <h2 className="text-3xl font-black">{group.tier}</h2>
              </div>
                ...
                {group.plans.map((plan) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <p className="text-2xl font-black text-yellow-400 whitespace-nowrap">
